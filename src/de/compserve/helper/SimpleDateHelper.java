...
public class SimpleDateHelper {
	...
	public int getDiffdays() {
	    ...
	    // Compute difference between two date objects and convert them into days
	...
	public int getToday() {
		...
		int today = this.cal2.get(this.cal2.DAY_OF_WEEK);
		return today;
	...
	public String[] getThisWeek() {
		...
		this.cal2.add(this.cal2.DAY_OF_MONTH, diffDays);
		...
		for (int i=0; i<=5; i++) {
			...
			this.cal2.add(this.cal2.DATE, 1);
		}
