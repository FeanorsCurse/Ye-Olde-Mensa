...
public class YeOldeMensa extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.refresh:
			if (mensa == null) {
				Toast.makeText(
						YeOldeMensa.this,
						"Keine Mensa ausgewÃ¤hlt. Bitte erst eine Mensa in den Einstellungen auswÃ¤hlen!",
	...
	private void settingsDialog() {
		...
		try {
			...
			displayException(
					e,
					"Fehler im Datenformat auf yeoldemensa.de. Das sollte nicht passieren! Wir arbeiten wahrscheinlich schon dran... Falls es bis morgen nicht wieder lÃ¤uft, schicke bitte eine Email an info@yeoldemensa.de!");
			return;
			...
			displayException(
					e,
					"Fehler beim Auslesen der Mensadaten von www.yeoldemensa.de! Wir arbeiten wahrscheinlich schon dran... Falls es bis morgen nicht wieder lÃ¤uft, schicke bitte eine Email an info@yeoldemensa.de!");
			return;
		}
		...
		try {
			...
			if (mensa == null) {
				((TextView) findViewById(R.id.headermensa))
						.setText("Keine Mensa ausgewÃ¤hlt...");
			} else {
